...
-  Standardize the summary statistics before performing the MR analysis. he summary statistics are standardized as z-statistics and then rescaled by the sample size for both continuous and binary traits.
